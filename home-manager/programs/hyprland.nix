  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      windowrule = [
        ...
        "workspace 2, class:^(Linear)$"
        "workspace 4, class:^(Code)$"
        "workspace 4, class:^(jetbrains-goland)$"
        "workspace 4, class:^(dev.zed.Zed)$"
        "workspace 5, class:^(notion)$"
        "workspace 7, class:^(firefox)$"
        "workspace 7, class:^(zen)$"
        "workspace 7, class:^(google-chrome)$"
        "workspace 8, class:^(kitty)$"
        "workspace 9, class:^(DBeaver)$"
        "workspace 10, class:^(claude)$"
      ];
    };
  };
